...
# DÜZELIŞ 1: Render-de 400 Bad Request / CORS / WebSocket 500 ýalňyşlyklaryny aýyrmak üçin
# 'async_mode' we 'cors_allowed_origins' sazlamalary takyqlandy.
socketio = SocketIO(
    app, 
...
if __name__ == '__main__':
    # DÜZELIŞ 2: Render serweriniň dynamic PORT bermegi üçin os.environ goşuldy
